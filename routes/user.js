...
router.post(
  ...
  userauth.checksession,
  userauth.checkBan,
  usercontroller.checkoutaddaddress
);
router.post(
  "/set-default-address",
  userauth.checksession,
  userauth.checkBan,
  usercontroller.checkoutchangeaddress
);
router.get(
  "/Ordersuccess",
  userauth.checksession,
  userauth.checkBan,
  usercontroller.loadordersuccess
);
router.post(
  "/order-details",
  userauth.checksession,
  userauth.checkBan,
  usercontroller.addorderdetails
);
router.get(
  "/userprofile",
  userauth.checksession,
...
router.get(
  ...
  userauth.checksession,
  userauth.checkBan,
  usercontroller.loadorderdetils
);
router.delete(
  "/cancel-order/:orderId/:productId",
  userauth.checksession,
  userauth.checkBan,
